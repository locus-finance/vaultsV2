...
import type {
  IPYieldToken,
  IPYieldTokenInterface,
} from "../../../../../@pendle/core-v2/contracts/interfaces/IPYieldToken";
...
export class IPYieldToken__factory {
  ...
  static createInterface(): IPYieldTokenInterface {
    return new Interface(_abi) as IPYieldTokenInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IPYieldToken {
    return new Contract(address, _abi, runner) as unknown as IPYieldToken;
  }
}
