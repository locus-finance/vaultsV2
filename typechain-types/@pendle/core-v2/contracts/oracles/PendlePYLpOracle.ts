...
export interface PendlePYLpOracleInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface PendlePYLpOracle extends BaseContract {
  connect(runner?: ContractRunner | null): PendlePYLpOracle;
  waitForDeployment(): Promise<this>;

  interface: PendlePYLpOracleInterface;
