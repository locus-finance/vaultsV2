...
export interface IPActionSwapYTV3Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "swapExactPtForYt"
      | "swapExactSyForYt"
...
export interface IPActionSwapYTV3 extends BaseContract {
  connect(runner?: ContractRunner | null): IPActionSwapYTV3;
  waitForDeployment(): Promise<this>;

  interface: IPActionSwapYTV3Interface;
