...
export interface IPActionAddRemoveLiqV3Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IPActionAddRemoveLiqV3 extends BaseContract {
  connect(runner?: ContractRunner | null): IPActionAddRemoveLiqV3;
  waitForDeployment(): Promise<this>;

  interface: IPActionAddRemoveLiqV3Interface;
