...
export interface IPActionSwapPTV3Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "swapExactPtForSy"
      | "swapExactPtForToken"
...
export interface IPActionSwapPTV3 extends BaseContract {
  connect(runner?: ContractRunner | null): IPActionSwapPTV3;
  waitForDeployment(): Promise<this>;

  interface: IPActionSwapPTV3Interface;
